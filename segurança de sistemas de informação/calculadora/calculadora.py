...
def calc():
    ...
    while True:
        ...
        if escolha == '1':  # Adição
            ...
            print(f"Resultado da Adição: {num1 + num2}, - Feita por Eduardo Romanini Pessoa")

        elif escolha == '2':  # Subtração
            num1 = float(input('Informe seu primeiro número: '))
            num2 = float(input('Informe seu segundo número: '))
            print(f"Resultado da Subtração: {num1 - num2}, Feita por Eduardo Romanini Pessoa")

        elif escolha == '3':  # Multiplicação
            num1 = float(input('Informe seu primeiro número: '))
            num2 = float(input('Informe seu segundo número: '))
            print(f"Resultado da Multiplicação: {num1 * num2}, Feita por Eduardo Romanini Pessoa")

        elif escolha == '4':  # Divisão
            num1 = float(input('Informe seu primeiro número: '))
            num2 = float(input('Informe seu segundo número: '))
            if num2 != 0:
                print(f"Resultado da Divisão: {num1 / num2}, Feita por Eduardo Romanini Pessoa")
            else:
            ...
            print(f"Resultado da Potenciação: {math.pow(base, expoente)}, Feita por Eduardo Romanini Pessoa")

        elif escolha == '6':  # Raiz Quadrada
            num = float(input('Digite o número para calcular a raiz quadrada: '))
            if num >= 0:
                print(f"Resultado da Raiz Quadrada: {math.sqrt(num)}, Feita por Eduardo Romanini Pessoa")
            else:
                print("Erro! Não é possível calcular a raiz quadrada de um número negativo.")

        elif escolha == '7':  # Pi (π)
            print(f"Valor de Pi: {math.pi}, Feita por Eduardo Romanini Pessoa")

        elif escolha == '8':  # Tangente
            angulo = float(input('Digite o ângulo em graus: '))
            radiano = math.radians(angulo)
            print(f"Resultado da Tangente: {math.tan(radiano)}, Feita por Eduardo Romanini Pessoa")

        elif escolha == '9':  # Cosseno
            angulo = float(input('Digite o ângulo em graus: '))
            radiano = math.radians(angulo)
            print(f"Resultado do Cosseno: {math.cos(radiano)}, Feita por Eduardo Romanini Pessoa")

        elif escolha == '10':  # Seno
            angulo = float(input('Digite o ângulo em graus: '))
            radiano = math.radians(angulo)
            print(f"Resultado do Seno: {math.sin(radiano)}, Feita por Eduardo Romanini Pessoa")

        elif escolha == '11':  # Logaritmo
            num = float(input('Digite o número para calcular o logaritmo: '))
            if num > 0:
                print(f"Resultado do Logaritmo: {math.log(num)}, Feita por Eduardo Romanini Pessoa")
            else:
            ...
            if num < 0:
                ...
                print(f"Resultado do Fatorial: {math.factorial(num)}, Feita por Eduardo Romanini Pessoa")

        elif escolha == '13':  # Sair do aplicativo 
